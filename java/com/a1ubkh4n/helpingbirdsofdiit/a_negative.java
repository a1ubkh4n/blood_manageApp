...
public class a_negative extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new list("Nabil","Daffodil Institute of IT","10th batch","Farmgate","No"));
        words.add(new list("Famim Akter Asha","Daffodil Institute of IT","13th batch","Lalbag","Yes"));
        words.add(new list("Shahid roxy","Daffodil Institute of IT","14th batch","Not available","No"));
